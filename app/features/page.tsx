...
const features = [
  {
    ...
    description:
      'Advanced machine learning to analyze Ayurveda formulations and identify IP vulnerabilities.',
  },
  {
    icon: Globe,
    title: 'Multilingual Support',
    description:
      'Access guidance in 6+ languages including Hindi, Sanskrit, Tamil, Telugu, Marathi, and English.',
  },
  {
    icon: Lock,
    title: 'IP Protection',
    description:
      'Comprehensive strategies for patents, trademarks, trade secrets, and geographical indications.',
  },
  {
    icon: FileText,
    title: 'Documentation Assist',
    description:
      'AI-guided documentation of formulations with proper technical specifications and heritage information.',
  },
  {
    icon: Zap,
    title: 'Real-Time Regulatory',
    description:
      'Up-to-date information on regulatory requirements across 15+ international regimes.',
  },
  {
    icon: BarChart3,
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 border-t border-white/10">
        <motion.div {...fadeInUp} className="mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-3xl">
            Our Retrieval-Augmented Generation system combines the latest AI models with
            authoritative IP and regulatory databases, ensuring every recommendation is backed by
            verified sources.
          </p>
        </motion.div>
          ...
          {[
            {
              title: 'Retrieval',
              description:
                'Sources from 50+ authoritative databases including WIPO, USPTO, and Indian IP databases.',
              items: ['Patent Databases', 'Regulatory Docs', 'Case Law', 'Formulation Libraries'],
            },
            {
              title: 'Augmentation',
              description:
                'Context-aware processing ensures recommendations are specific to Ayurveda sector.',
              items: [
                'Domain Tuning',
                'Regulatory Mapping',
                'Language Processing',
            ...
            },
            {
              title: 'Generation',
              description:
                "Produces actionable, source-cited guidance in user's preferred language.",
              items: [
                'Compliance Reports',
                'Protection Plans',
          ...
          {[
            {
              ...
              tasks: [
                'Document proprietary formulations',
            ...
            },
            {
              role: 'Researchers',
              tasks: [
                'Identify unprotected IP spaces',
