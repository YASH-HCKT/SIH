...
// Replace the placeholder names and roles below with your final team details.
const teamMembers = [
  { name: 'Team Member 01', role: 'Project Lead', initials: '01', tone: 'bg-[#dcefe1] text-[#2f855a]' },
  { name: 'Team Member 02', role: 'AI & Machine Learning', initials: '02', tone: 'bg-[#fff0df] text-[#c26726]' },
  { name: 'Team Member 03', role: 'Frontend Engineering', initials: '03', tone: 'bg-[#e8e3f5] text-[#6d5aa7]' },
  { name: 'Team Member 04', role: 'Backend & Data', initials: '04', tone: 'bg-[#e2f0f0] text-[#287779]' },
  { name: 'Team Member 05', role: 'Ayurveda & IP Research', initials: '05', tone: 'bg-[#f8e7e7] text-[#a84e5a]' },
  { name: 'Team Member 06', role: 'Product & Design', initials: '06', tone: 'bg-[#f3ecd8] text-[#98752b]' },
];
